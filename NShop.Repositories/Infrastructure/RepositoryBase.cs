...
namespace NShop.Repositories.Infrastructure
{
    ...
    {
        #region Properties
        private NShopDbContext dataContext;
        ...
        protected NShopDbContext DbContext
        {
        ...
        public virtual void AddMulti(List<T> entities)
        {
        ...
        public virtual void UpdateMulti(List<T> entities)
        {
            foreach (T item in entities)
            {
                dbSet.Attach(item);
