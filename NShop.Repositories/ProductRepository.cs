...
using NShop.Repositories.Common;
...
namespace NShop.Repositories
{
    public interface IProductRepository : IRepository<Product>
    {
        ...
        Task<int> Delete1(int productId);
    ...
    public class ProductRepository : RepositoryBase<Product>, IProductRepository
    {
        ...
        public ProductRepository(IDbFactory dbFactory, NShopDbContext context, IStorageService storageService) : base(dbFactory)
        {
            _context = context;
        ...
        public async Task<int> Delete1(int productId)
        {
            var product = await _context.Products.FindAsync(productId);
        ...
        public async Task<ProductImageViewModel> GetImageById(int imageId)
        {
            ...
            if (image == null)
                throw new NShopException($"Cannot find an image with id {imageId}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new NShopException($"Cannot find a product with id: {productId}");
